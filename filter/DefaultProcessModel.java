...
public class DefaultProcessModel implements ProcessModel {
	/**
	 * The state transition matrix, used to advance the internal state estimation
	 * each time-step.
	 */
	 ...
	 * @throws NoDataException            if any row / column dimension of the input
	 *                                    matrices is zero
	 * @throws DimensionMismatchException if any of the input matrices is
	 *                                    non-rectangular
	 */
	public DefaultProcessModel(final double[][] stateTransition, final double[][] control,
			final double[][] processNoise, final double[] initialStateEstimate, final double[][] initialErrorCovariance)
	 ...
	 * Create a new {@link ProcessModel}, taking double arrays as input parameters.
	 * <p>
	 * The initial state estimate and error covariance are omitted and will be
	 * initialized by the {@link KalmanFilter} to default values.
	 *
	 * @param stateTransition the state transition matrix
	 * @param control         the control matrix
	 * @param processNoise    the process noise matrix
	 ...
	 */
	public DefaultProcessModel(final double[][] stateTransition, final double[][] control,
			final double[][] processNoise) throws NullArgumentException, NoDataException, DimensionMismatchException {
	 ...
	 * @param initialErrorCovariance the initial error covariance matrix
	 */
	public DefaultProcessModel(RealMatrix stateTransition, RealMatrix control, RealMatrix processNoise,
			RealVector initialStateEstimate, RealMatrix initialErrorCovariance) {
